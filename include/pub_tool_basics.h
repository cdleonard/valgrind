...
#undef VG_LITTLEENDIAN
    ...
    || ((defined(VGA_mips32) || defined(VGA_mips64) || defined(VGA_mips64n32)) && defined (_MIPSEL)) \
    || defined(VGA_arm64)  || defined(VGA_ppc64le) || defined(VGA_tilegx)
#  define VG_LITTLEENDIAN 1
#elif defined(VGA_ppc32) || defined(VGA_ppc64be) || defined(VGA_s390x) \
      || ((defined(VGA_mips32) || defined(VGA_mips64) || defined(VGA_mips64n32)) && defined (_MIPSEB))
